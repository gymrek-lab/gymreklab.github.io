...
5. Connect your Zoom video to the room's camera. In FAH 4002, you can select "" from among the list of options.
6. Connect your Zoom microphone to the room's microphone. In FAH 4002, you can select "" from among the list of options. You might want to double-check that someone on zoom can hear someone else on the opposite side of the room.
7. Test that audio from zoom is properly routed to the room's speakers. Have someone else log into the Zoom and say something through their device.
