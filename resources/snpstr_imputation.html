...
Shubham Saini<sup>1,2</sup>, Ileena Mitra<sup>2,3</sup>, Melissa Gymrek<sup>1,2*</sup>
...
- 2504 samples from the [1000 Genomes Project](http://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/) Phase 3 SNP Haplotypes
- STRs imputed from the 1916 samples of the Simons Simplex Collection
- Total 27630964 SNP + STR markers
...
We suggest using the latest version 4.1. If you are working with related samples, use [Beagle version 4.0](https://faculty.washington.edu/browning/beagle/b4_0.html)
